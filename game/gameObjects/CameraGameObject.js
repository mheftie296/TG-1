class CameraGameObject extends GameObject{
    ...
    update(){
        ...
        this.transform.y -= movement.direction[0] * Math.cos(this.tr)*0.1//-MainScene.tr)*0.1
        this.transform.x -= movement.direction[0] * Math.sin(this.tr)*0.1//-MainScene.tr)*0.1
        let hit = false
